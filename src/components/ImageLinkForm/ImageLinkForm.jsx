  ...
  return (
    <div className="m-2 my-4 py-4 rounded-lg shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] bg-gradient-to-r from-gray-700 via-gray-900 to-black">
      ...
      <div className="p-2 ">
        <input
          type="text"
          className="w-4/5 p-1 rounded my-2"
          onChange={onInputChange}
        />
        <button
          onClick={onButtonSubmit}
          className="relative inline-flex items-center justify-center p-1 px-4 m-1 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out rounded-full shadow-xl group hover:ring-1 hover:ring-purple-500 active:scale-95"
        >
